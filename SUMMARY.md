...
* [Effective Java](study/effective-java/README.md)
  * [2 객체 생성과 파괴](study/effective-java/2/README.md)
    ...
    * [#2. 생성자에 매개변수가 많다면 빌더를 고려하라](study/effective-java/2/2..md)
    * [#3. private 생성자나 열거 타입으로 싱글턴임을 보증하라](study/effective-java/2/3.-private.md)
    * [#4. 인스턴스화를 막으려거든 private 생성자를 사용하라](study/effective-java/2/4.-private.md)
    * [#5. 리소스를 엮을 때는 의존성 주입을 선호하라](study/effective-java/2/5..md)
